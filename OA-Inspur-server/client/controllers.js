...
angular.module('app', ['angularFileUpload'])
  ...
  .controller('TestController',function ($scope, FileUploader) {
    ...
    $scope.load = function () {
      $http.get('/api/Files/portrait/files').success(function (data) {
        console.log(data);
        $scope.files = data;
      });
    };
    ...
    $scope.delete = function (index, id) {
      $http.delete('/api/Files/portrait/files/' + encodeURIComponent(id)).success(function (data, status, headers) {
